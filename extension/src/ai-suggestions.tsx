      ...
      {suggestions.map((suggestion, index) => (
        <List.Item
          ...
          actions={
            <ActionPanel>
              <Action
                title="Create This Macro"
                icon="⚡"
                onAction={() => createMacroFromSuggestion(suggestion)}
              />
              <Action.Push
                title="View Details"
                target={<SuggestionDetails suggestion={suggestion} onCreateMacro={() => createMacroFromSuggestion(suggestion)} />}
              />
              <Action
