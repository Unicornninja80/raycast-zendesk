...
export default function TestAI() {
  ...
  async function testAISystem() {
    ...
    try {
      ...
      if (!isEnabled) {
        testResults += "**Issue:** AI service is not enabled. Check your OpenAI API key and enable AI macros in preferences.\n\n";
      }
      ...
      if (!isEnabled) {
        ...
        testResults += "**🎉 Everything is working!** Check the 'AI Macro Suggestions' command to see your suggestions.\n";
      }
