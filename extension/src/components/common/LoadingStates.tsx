...
export function LoadingState({ title = "Loading...", message = "Please wait while we fetch your data", icon = "⏳" }: LoadingStateProps) {
  return (
    <Detail
      markdown={`# ${icon} ${title}\n\n${message}`}
      actions={
...
export function LoadingList({ title = "Loading...", message = "Please wait while we fetch your data" }: LoadingStateProps) {
  return (
    <List isLoading={true}>
...
export function LoadingForm({ title = "Loading...", message = "Please wait while we prepare the form" }: LoadingStateProps) {
  return (
    <Form isLoading={true}>
      ...
      actions={
        <ActionPanel>
          <Action.Push 
            ...
            icon="➕" 
            target={<div>Create Macro Form</div>} 
          />
        </ActionPanel>
      }
    />
