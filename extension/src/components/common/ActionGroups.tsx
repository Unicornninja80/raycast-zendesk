...
interface TicketManagementActionsProps {
  ...
  onManageTicket: React.ReactElement;
  onApplyMacro: React.ReactElement;
  onConvertToArticle: React.ReactElement;
}
  ...
  return (
    <>
      <ActionPanel.Section title="Ticket Actions">
        ...
        <Action.OpenInBrowser title="Open in Browser" onAction={onOpenInBrowser} />
      ...
      {onPromote && (
        <ActionPanel.Section title="Publishing">
          <Action 
            ...
            icon="⭐" 
            onAction={() => onPromote(articleId, articleTitle)} 
          />
        </ActionPanel.Section>
      )}
      ...
      {onArchive && (
        <ActionPanel.Section title="Archiving">
          <Action 
            ...
            icon="📦" 
            onAction={() => onArchive(articleId, articleTitle)} 
          />
        </ActionPanel.Section>
      )}
...
interface MacroManagementActionsProps {
  ...
  ticketId?: number;
  onViewDetails: React.ReactElement;
  onPreviewChanges?: React.ReactElement;
  onApplyToTicket?: (macroId: number, macroTitle: string) => void;
  onCreateNew: React.ReactElement;
  onAISuggestions: React.ReactElement;
}
  ...
  return (
    <>
      <ActionPanel.Section title="Macro Actions">
        ...
        {ticketId && onPreviewChanges && (
          <Action.Push
            title="Preview Changes"
            target={onPreviewChanges}
          />
        )}
      </ActionPanel.Section>
