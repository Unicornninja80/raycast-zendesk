...
Focus on common support patterns like password resets, account issues, billing questions, technical troubleshooting, etc.`;
    ...
    const response = await fetch(this.baseUrl, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are an expert Zendesk automation consultant who helps create efficient macros from ticket patterns. Always respond with valid JSON.",
          },
          {
            role: "user",
            content: prompt,
  ...
  private extractKeywords(text: string): string[] {
    ...
    const stopWords = new Set(["the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for", "of", "with", "by", "is", "are", "was", "were", "be", "been", "have", "has", "had", "do", "does", "did", "will", "would", "could", "should", "may", "might", "can", "cannot", "i", "you", "he", "she", "it", "we", "they", "me", "him", "her", "us", "them"]);
